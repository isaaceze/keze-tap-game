 ...
 * Purpose: Database configuration for Keze Tap Game
 * Features: MySQL connection with error handling and connection pooling
 */

// Database configuration
$servername = "localhost";
$username = "bisskhgv_kezeuser"; // Replace with your actual database username
$password = "KezeTap2025!"; // Replace with your actual database password
$dbname = "bisskhgv_keze_tap_game"; // Replace with your actual database name
